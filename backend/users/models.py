...
class User(AbstractUser):
    ...
    followers = models.ManyToManyField('self', related_name="following_set", symmetrical=False)
    following = models.ManyToManyField('self', related_name="followers_set", symmetrical=False)
